        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
          <div className="flex-col space-y-5 ">
            ...
            <p>
              ...
              <a
                href="#"
                className="block text-2xl font-BlackOps font-medium text-gray-900 hover:opacity-75 sm:text-3xl"
              >
                +216 27 224 119
              </a>
            </p>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              <p className="font-semibold font-IBMPlex  text-gray-900">
                Company
              </p>
              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <a
                    href="#"
                    className="text-gray-700 transition font-IBMPlex capitalize hover:text-valar3 hover:underline hover:opacity-75"
                  >
                    About
                  </a>
                </li>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <ul className="flex flex-wrap gap-4 text-xs">
              <li>
                <a
                  href="#"
                  className="text-valar1 font-IBMPlex transition hover:opacity-75"
                >
                  Terms &amp; Conditions
                </a>
              </li>
            ...
            <p className="mt-8 text-xs font-IBMPlex text-gray-500 sm:mt-0">
              © 2024. Valar Dohaerys. All rights reserved.
            </p>
          </div>
        </div>
      </div>
